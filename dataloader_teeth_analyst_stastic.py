...
def getData(mode, Istestori = False):
    ...
    if Istestori == True:
        ...
        with open(filename,'r') as dicctionary:   
            ...
            #data = data[6000:8000] #origin test 6000-8000 0-2000 -2000
    ...
    with open(filename,'r') as dicctionary:   
        ...
        if mode == 'train':
            data = data[:120000].sample(30000)#132000
        elif mode == 'test':
            #data = data
            data = data[120000:160000]#.sample(10000)
        elif mode == 'val':
            data = data[160000:].sample(8000)
...
#         if mode == 'train':
#             data = data[:131040].sample(33000)#14000 240000 274000
#         elif mode == 'test':
#             #data = data
#             data = data[151040:].sample(10000)
#         elif mode == 'val':
#             data = data[131040:151040].sample(8000)
